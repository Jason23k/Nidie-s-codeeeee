...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='vid_multi', type=str,
                        choices=['coco', 'vid_multi', 'vid_single', 'ships'],
                        help="Choose dataset: 'coco', 'vid_multi', 'vid_single', or 'ships'")
    parser.add_argument('--ship_path', default=r"D:\广财\F's research\ShipsVideos", type=str,
                        help="Root path for ShipsVideos dataset (used when dataset_file='ships')")
    ...
    parser.add_argument('--resume', default=r'D:\TransVOD\TransVOD-master\exps\our_models\exps_multi\checkpoint.pth',
                        type=str,
                        help='resume from checkpoint (override for ships)')
...
def main(args):
    ...
    if args.dataset_file == "ships":
        print(f"📂 Ship data root: {args.ship_path}")
    ...
    # 根据 dataset_file 动态选择 image_set
    if args.dataset_file == "ships":
        dataset_train = build_dataset(image_set='train', args=args)  # 用 'train'
        dataset_val = build_dataset(image_set='val', args=args)  # 用 'val'
    else:
